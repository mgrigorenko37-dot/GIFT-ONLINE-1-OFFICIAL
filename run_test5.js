...
code = code.replace("Liquidation of Long position when mark price drops below maintenance margin", "Liquidation of Short position when mark price rises above maintenance margin");
