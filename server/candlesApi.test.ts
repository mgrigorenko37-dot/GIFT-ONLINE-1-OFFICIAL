...
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
...
// Scenario 10: 1m and 1M return different series
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c1", price: "12", quantity: "1", currency: "TON", eventTime: 1710000120000, status: "completed" }); // +2m
...
// Scenario 11: TON and STARS return different series
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c1", price: "500", quantity: "1", currency: "STARS", eventTime: 1710000000000, status: "completed" });
...
// Scenario 12: Different collections isolated
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c2", price: "20", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
...
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", modelId: "m1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c1", modelId: "m2", price: "30", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
...
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", backdropId: "b1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c1", backdropId: "b2", price: "40", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
...
// Scenario 15: from included (startTime >= from)
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m", from: 1710000000000 });
...
// Scenario 16: to excluded (startTime < to)
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m", to: 1710000000000 });
...
// Scenario 17: from == to gives empty result
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m", from: 1710000000000, to: 1710000000000 });
...
{
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m", from: 1710000000000, to: 1700000000000 });
...
{
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m", from: 1710000000 });
...
// Scenario 24: limit restricts number of candles
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c1", price: "12", quantity: "1", currency: "TON", eventTime: 1710000060000, status: "completed" });
  acceptCompletedSale({ id: "s3", collectionId: "c1", price: "14", quantity: "1", currency: "TON", eventTime: 1710000120000, status: "completed" });
...
{
  clearMarketState();
  acceptCompletedSale({ id: "sLater", collectionId: "c1", price: "12", quantity: "1", currency: "TON", eventTime: 1710000120000, status: "completed" });
  acceptCompletedSale({ id: "sEarlier", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m" });
  assert(res.body.candles[0].startTime < res.body.candles[1].startTime, "Scenario 25: Sorted ASC");
...
// Scenario 26: Duplicates absent
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: 1710000000000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c1", price: "12", quantity: "1", currency: "TON", eventTime: 1710000010000, status: "completed" });
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m" });
...
// Scenario 27: Empty history does not cause 500
{
  ...
  assert(Array.isArray(res.body.candles) && res.body.candles.length === 0, "Scenario 27: Empty candles array");
...
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "10", quantity: "1", currency: "TON", eventTime: Date.now(), status: "completed" });
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m" });
  assert(res.body.candles.length === 1, "Scenario 28: Active candle returned");
  assert(res.body.candles[0].confirmed === false, "Scenario 28: Active candle confirmed is false");
...
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "100", quantity: "1", currency: "TON", eventTime: 1710000010000, status: "completed" });
  acceptCompletedSale({ id: "s2", collectionId: "c1", price: "120", quantity: "1", currency: "TON", eventTime: 1710000070000, status: "completed" }); // next candle
  acceptCompletedSale({ id: "sLate", collectionId: "c1", price: "150", quantity: "1", currency: "TON", eventTime: 1710000020000, status: "completed" }); // late in first candle
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m" });
  assert(res.body.candles[0].high === "150", "Scenario 29: Closed candle updated with new high");
...
{
  clearMarketState();
  acceptCompletedSale({ id: "s1", collectionId: "c1", price: "0.1", quantity: "3", currency: "TON", eventTime: 1710000000000, status: "completed" });
  const res = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m" });
  const c = res.body.candles[0];
  assert(typeof c.open === "string" && c.open === "0.1", "Scenario 30: open is string '0.1'");
  assert(typeof c.quoteVolume === "string" && c.quoteVolume === "0.3", "Scenario 30: quoteVolume is string '0.3'");
...
// Scenario 33: Cursor pagination does not skip or duplicate candles
{
  ...
  assert(p1.body.nextCursor === "1710000060000", "Scenario 33: Page 1 nextCursor is 1710000060000");

  // Page 2: use cursor from Page 1
  const p2 = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m", limit: 2, cursor: p1.body.nextCursor });
  assert(p2.body.candles.length === 2, "Scenario 33: Page 2 length is 2");
  assert(p2.body.candles[0].startTime === 1710000120000, "Scenario 33: Page 2 starts at next candle without duplicate");
  assert(p2.body.nextCursor === "1710000180000", "Scenario 33: Page 2 nextCursor is 1710000180000");

  // Page 3: use cursor from Page 2
  const p3 = mockApiCall({ instrumentKey: "c1:all:all:TON", timeframe: "1m", limit: 2, cursor: p2.body.nextCursor });
