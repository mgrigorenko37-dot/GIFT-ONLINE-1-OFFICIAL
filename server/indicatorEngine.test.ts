...
describe('Stage 12: Telegram Gifts Technical Indicators Scenarios', () => {
  test('Runs Stage 12 Indicator Engine Scenarios', () => {
    ...
    // 6. Active candle & provisional status
    {
      ...
      assert(
        lastPoint.isProvisional === true,
        'Test 6: Active candle indicator is marked as isProvisional = true'
      );

      console.log(
        '✓ Test 6 passed: Active candle indicator is correctly marked as isProvisional = true'
      );
    }
    ...
    // 7. Correction / Recalculation
    {
      ...
      assert(
        res2.points[0].value === '30',
        'Test 7: After correction, SMA(1) updated to 30 (new close)'
      );
    ...
    // 8. Independent calculation across ALL timeframes
    {
      ...
      console.log(
        '✓ Test 8 passed: Independent indicator calculations supported for all 9 timeframes'
      );
    }
    ...
    // 9. Different Data Sources (close, floor, average)
    {
      ...
      assert(
        averageRes.points[0].value === '10',
        'Test 9: Source average is 10 (20 quote / 2 qty)'
      );
