...
describe('Stage 13 / Stage 4 Realtime Manager & Reconnect Recovery Tests', () => {
  test('Scenario 1: Complete reconnect scenario', () => {
    resetAll();
  ...
  test('Scenario 2: Reconnect during REST request isolates stale config token', () => {
    resetAll();
  ...
  test('Scenario 3: Reconnect during timeframe switch isolates timeframes', () => {
    resetAll();
  ...
  test('Scenario 4: Sequence gap detection & recovery', () => {
    resetAll();
    const sequenceTracker = new SequenceTracker();
  ...
  test('Scenario 5: Duplicate snapshot merge idempotency', () => {
    resetAll();
    const candleStore = new CandleStore(instA, tf1m);
    const saleTracker = new SaleTracker(instA);
  ...
  test('Scenario 6: Stale revision rejected and newer revision preserved', () => {
    resetAll();
    const candleStore = new CandleStore(instA, tf1m);
  ...
  test('Scenario 7: Late sale recalculates candle and updates in-place without duplicate', () => {
    resetAll();
    acceptCompletedSale({
      id: 'sale-normal-1',
      collectionId: 'durov-cap',
  ...
  test('Scenario 8: Duplicate subscription handles recovery without stream duplication', () => {
    resetAll();
  ...
  test('Scenario 9: Multiple clients strictly isolated by subscription', () => {
    resetAll();
